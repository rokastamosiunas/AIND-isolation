...
if __name__ == "__main__":
    ...
    for score in [custom_score, custom_score_2, custom_score_3]:
        L=[]
        O=[]
        print(score)
        for _ in range(10):
            ...
            L.append(player1 == winner)
            O.append(outcome)

        print('player1 win rate: {0}'.format(100*sum(L)/len(L)))
        print(Counter(O))